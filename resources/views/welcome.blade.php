...
<head>
    ...
    <title>Laravel Samplessssss</title>
    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/home') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">Homssssssssssse</a>
                @else
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-gray-900 dark:text-white">Documasdasdasdasdadasentation</a>
                            </div>
                        </div>
